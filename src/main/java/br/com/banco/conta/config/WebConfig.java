...
public class WebConfig {
	...
	protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/banco/usuario/{username}").hasAnyAuthority("ADMIN", "USER")
		.antMatchers(HttpMethod.PUT, "/banco/usuario").hasAnyAuthority("ADMIN", "USER")
		.antMatchers(HttpMethod.DELETE, "/banco/usuario/{id}").hasAnyAuthority("ADMIN", "USER")
